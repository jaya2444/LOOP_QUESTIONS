...
# We will again take input from the user. If the user gives 7as a number then we will check if 7 is less than 5 or not so it is False then we will print "Number entered by you entered is greater, try one more time ".
...
i=0
while i<=n1:
    guess=int(input("enter the any guess number"))
    if guess<n1:
        print("small")
    elif guess>n1:
        print("greater")
